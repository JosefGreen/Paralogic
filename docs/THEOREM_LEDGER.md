...
| G6-M1-1 | M1 has an evidence-overclaim profile with claim-scope, relevance, insufficiency, scope, uncertainty, materiality, and adequacy-boundary conditions | `EvidenceOverclaimProfile`, `EvidenceOverclaimProfileSatisfied` |
| G6-M1-2 | a satisfied M1 evidence-overclaim profile warrants support degradation | `EvidenceOverclaimProfile_to_supportDegraded` |
| G6-M1-3 | an M1 evidence-overclaim profile converts to a generic mechanism profile labelled M1 | `EvidenceOverclaimProfile.toMechanismProfile`, `EvidenceOverclaimProfile_mechanism_label`, `EvidenceOverclaimProfile_to_mechanism_satisfied` |
| G6-M1-4 | a satisfied M1 overclaim case projects to ISF semantics | `M1EvidenceOverclaimCase`, `M1EvidenceOverclaimSatisfied`, `M1EvidenceOverclaimCase_to_ISFSem` |
| G6-M1-5 | each missing M1 condition blocks the evidence-overclaim profile | `missing_claim_scope_blocks_overclaim`, `irrelevant_evidence_blocks_overclaim`, `sufficient_evidence_blocks_overclaim`, `matched_scope_blocks_overclaim`, `bounded_uncertainty_blocks_overclaim`, `immaterial_overclaim_blocks_overclaim`, `present_adequacy_boundary_blocks_overclaim` |
| G6-M1-6 | concrete M1 negative-control profiles witness every blocker | `evidenceOverclaimNoScopeProfile_blocked`, `evidenceOverclaimIrrelevantProfile_blocked`, `evidenceOverclaimSufficientProfile_blocked`, `evidenceOverclaimMatchedScopeProfile_blocked`, `evidenceOverclaimBoundedUncertaintyProfile_blocked`, `evidenceOverclaimImmaterialProfile_blocked`, `evidenceOverclaimBoundaryPresentProfile_blocked` |
...
| G6-M3-1 | M3 has a formal-access substitution profile with formal access, substantive absence, substitution, usability, comprehension, remedy, and boundary conditions | `FormalAccessProfile`, `FormalAccessProfileSatisfied` |
| G6-M3-2 | a satisfied M3 formal-access profile warrants support degradation | `FormalAccessProfile_to_supportDegraded` |
| G6-M3-3 | an M3 formal-access profile converts to a generic mechanism profile labelled M3 | `FormalAccessProfile.toMechanismProfile`, `FormalAccessProfile_mechanism_label`, `FormalAccessProfile_to_mechanism_satisfied` |
| G6-M3-4 | a satisfied M3 access-substitution case projects to ISF semantics | `M3FormalAccessSubstitutionCase`, `M3FormalAccessSubstitutionSatisfied`, `M3FormalAccessSubstitutionCase_to_ISFSem` |
| G6-M3-5 | each missing M3 condition blocks the formal-access profile | `missing_formal_access_blocks_profile`, `substantive_access_present_blocks_profile`, `access_not_treated_sufficient_blocks_profile`, `immaterial_usability_barrier_blocks_profile`, `immaterial_comprehension_barrier_blocks_profile`, `present_remedy_path_blocks_profile`, `present_access_boundary_blocks_profile` |
| G6-M3-6 | concrete M3 negative-control profiles witness every blocker | `formalAccessNoDeclarationProfile_blocked`, `formalAccessSubstantivePresentProfile_blocked`, `formalAccessNotSubstitutedProfile_blocked`, `formalAccessUsableProfile_blocked`, `formalAccessComprehensibleProfile_blocked`, `formalAccessRemedyPresentProfile_blocked`, `formalAccessBoundaryPresentProfile_blocked` |
| G6-M4-1 | M4 has a symbolic-substitution profile with symbol, substitution, mismatch, material condition, audience uptake, correction, and boundary conditions | `SymbolicSubstitutionProfile`, `SymbolicSubstitutionProfileSatisfied` |
| G6-M4-2 | a satisfied M4 symbolic-substitution profile warrants support degradation | `SymbolicSubstitutionProfile_to_supportDegraded` |
| G6-M4-3 | an M4 symbolic-substitution profile converts to a generic mechanism profile labelled M4 | `SymbolicSubstitutionProfile.toMechanismProfile`, `SymbolicSubstitutionProfile_mechanism_label`, `SymbolicSubstitutionProfile_to_mechanism_satisfied` |
| G6-M4-4 | a satisfied M4 symbolic-substitution case projects to ISF semantics | `M4SymbolicSubstitutionCase`, `M4SymbolicSubstitutionSatisfied`, `M4SymbolicSubstitutionCase_to_ISFSem` |
| G6-M4-5 | each missing M4 condition blocks the symbolic-substitution profile | `missing_symbol_blocks_profile`, `symbol_not_substituted_blocks_profile`, `matched_representation_blocks_profile`, `material_condition_present_blocks_profile`, `immaterial_audience_uptake_blocks_profile`, `present_symbolic_correction_blocks_profile`, `present_symbolic_boundary_blocks_profile` |
| G6-M4-6 | concrete M4 negative-control profiles witness every blocker | `symbolicSubstitutionNoSymbolProfile_blocked`, `symbolicSubstitutionNotSubstantiveProfile_blocked`, `symbolicSubstitutionMatchedProfile_blocked`, `symbolicSubstitutionMaterialPresentProfile_blocked`, `symbolicSubstitutionImmaterialUptakeProfile_blocked`, `symbolicSubstitutionCorrectionPresentProfile_blocked`, `symbolicSubstitutionBoundaryPresentProfile_blocked` |
| G6-M5-1 | M5 has a repair-failure profile with repair need, responsibility, plan, action, verification, recurrence, and closure conditions | `RepairFailureProfile`, `RepairFailureProfileSatisfied` |
| G6-M5-2 | a satisfied M5 repair-failure profile warrants support degradation | `RepairFailureProfile_to_supportDegraded` |
| G6-M5-3 | an M5 repair-failure profile converts to a generic mechanism profile labelled M5 | `RepairFailureProfile.toMechanismProfile`, `RepairFailureProfile_mechanism_label`, `RepairFailureProfile_to_mechanism_satisfied` |
| G6-M5-4 | a satisfied M5 repair-failure case projects to ISF semantics | `M5RepairFailureCase`, `M5RepairFailureSatisfied`, `M5RepairFailureCase_to_ISFSem` |
| G6-M5-5 | each missing M5 condition blocks the repair-failure profile | `missing_repair_need_blocks_profile`, `missing_repair_responsibility_blocks_profile`, `present_repair_plan_blocks_profile`, `successful_repair_action_blocks_profile`, `present_repair_verification_blocks_profile`, `immaterial_recurrence_blocks_profile`, `no_repair_closure_claim_blocks_profile` |
| G6-M5-6 | concrete M5 negative-control profiles witness every blocker | `repairFailureNoNeedProfile_blocked`, `repairFailureNoResponsibilityProfile_blocked`, `repairFailurePlanPresentProfile_blocked`, `repairFailureActionSuccessfulProfile_blocked`, `repairFailureVerifiedProfile_blocked`, `repairFailureNoRecurrenceProfile_blocked`, `repairFailureNoClosureClaimProfile_blocked` |
| G6-M6-1 | M6 has a translation-failure profile with source, target, translation, semantic-loss, actor-link, verification, and boundary conditions | `TranslationFailureProfile`, `TranslationFailureProfileSatisfied` |
| G6-M6-2 | a satisfied M6 translation-failure profile warrants support degradation | `TranslationFailureProfile_to_supportDegraded` |
| G6-M6-3 | an M6 translation-failure profile converts to a generic mechanism profile labelled M6 | `TranslationFailureProfile.toMechanismProfile`, `TranslationFailureProfile_mechanism_label`, `TranslationFailureProfile_to_mechanism_satisfied` |
| G6-M6-4 | a satisfied M6 translation-failure case projects to ISF semantics | `M6TranslationFailureCase`, `M6TranslationFailureSatisfied`, `M6TranslationFailureCase_to_ISFSem` |
| G6-M6-5 | each missing M6 condition blocks the translation-failure profile | `missing_source_context_blocks_translation`, `missing_target_context_blocks_translation`, `absent_translation_blocks_translation`, `immaterial_semantic_loss_blocks_translation`, `intact_actor_link_blocks_translation`, `present_translation_verification_blocks_translation`, `present_translation_boundary_blocks_translation` |
| G6-M6-6 | concrete M6 negative-control profiles witness every blocker | `translationFailureNoSourceProfile_blocked`, `translationFailureNoTargetProfile_blocked`, `translationFailureAbsentProfile_blocked`, `translationFailureImmaterialLossProfile_blocked`, `translationFailureLinkIntactProfile_blocked`, `translationFailureVerifiedProfile_blocked`, `translationFailureBoundaryPresentProfile_blocked` |
| G6-M9-1 | M9 has a veto-suppression profile with veto right, affected participant, attempt, suppression, materiality, review, and boundary conditions | `VetoSuppressionProfile`, `VetoSuppressionProfileSatisfied` |
| G6-M9-2 | a satisfied M9 veto-suppression profile warrants support degradation | `VetoSuppressionProfile_to_supportDegraded` |
| G6-M9-3 | an M9 veto-suppression profile converts to a generic mechanism profile labelled M9 | `VetoSuppressionProfile.toMechanismProfile`, `VetoSuppressionProfile_mechanism_label`, `VetoSuppressionProfile_to_mechanism_satisfied` |
| G6-M9-4 | a satisfied M9 veto-suppression case projects to ISF semantics | `M9VetoSuppressionCase`, `M9VetoSuppressionSatisfied`, `M9VetoSuppressionCase_to_ISFSem` |
| G6-M9-5 | each missing M9 condition blocks the veto-suppression profile | `missing_veto_right_blocks_profile`, `missing_affected_participant_blocks_profile`, `absent_veto_attempt_blocks_profile`, `unsuppressed_veto_blocks_profile`, `immaterial_veto_suppression_blocks_profile`, `present_veto_review_blocks_profile`, `present_veto_boundary_blocks_profile` |
| G6-M9-6 | concrete M9 negative-control profiles witness every blocker | `vetoSuppressionNoRightProfile_blocked`, `vetoSuppressionNoParticipantProfile_blocked`, `vetoSuppressionNoAttemptProfile_blocked`, `vetoSuppressionNotSuppressedProfile_blocked`, `vetoSuppressionImmaterialProfile_blocked`, `vetoSuppressionReviewPresentProfile_blocked`, `vetoSuppressionBoundaryPresentProfile_blocked` |
| G6-M10-1 | M10 has a frame-drift profile with source frame, target frame, frame shift, claim carryover, changed context, materiality, continuity, and boundary conditions | `FrameDriftProfile`, `FrameDriftProfileSatisfied` |
| G6-M10-2 | a satisfied M10 frame-drift profile warrants support degradation | `FrameDriftProfile_to_supportDegraded` |
| G6-M10-3 | an M10 frame-drift profile converts to a generic mechanism profile labelled M10 | `FrameDriftProfile.toMechanismProfile`, `FrameDriftProfile_mechanism_label`, `FrameDriftProfile_to_mechanism_satisfied` |
| G6-M10-4 | a satisfied M10 frame-drift case projects to ISF semantics and retains directional frame change | `M10FrameDriftCase`, `M10FrameDriftSatisfied`, `M10FrameDriftCase_to_ISFSem`, `M10FrameDriftCase_directional_change` |
| G6-M10-5 | each missing M10 condition blocks the frame-drift profile | `missing_source_frame_blocks_profile`, `missing_target_frame_blocks_profile`, `missing_frame_shift_blocks_profile`, `missing_frame_carry_blocks_profile`, `unchanged_context_blocks_profile`, `immaterial_frame_drift_blocks_profile`, `present_continuity_guard_blocks_profile`, `present_frame_boundary_blocks_profile` |
| G6-M10-6 | concrete M10 negative-control profiles witness every blocker | `frameDriftNoSourceProfile_blocked`, `frameDriftNoTargetProfile_blocked`, `frameDriftNoShiftProfile_blocked`, `frameDriftNoCarryProfile_blocked`, `frameDriftUnchangedContextProfile_blocked`, `frameDriftImmaterialProfile_blocked`, `frameDriftContinuityPresentProfile_blocked`, `frameDriftBoundaryPresentProfile_blocked` |
| G6-M11-1 | M11 has a symbolic-overload profile with symbol, interpretation, conflict, uptake, claim-dependence, disambiguation, evaluator-resolution, and boundary conditions | `SymbolicOverloadProfile`, `SymbolicOverloadProfileSatisfied` |
| G6-M11-2 | a satisfied M11 symbolic-overload profile warrants support degradation | `SymbolicOverloadProfile_to_supportDegraded` |
| G6-M11-3 | an M11 symbolic-overload profile converts to a generic mechanism profile labelled M11 | `SymbolicOverloadProfile.toMechanismProfile`, `SymbolicOverloadProfile_mechanism_label`, `SymbolicOverloadProfile_to_mechanism_satisfied` |
| G6-M11-4 | a satisfied M11 symbolic-overload case projects to ISF semantics | `M11SymbolicOverloadCase`, `M11SymbolicOverloadSatisfied`, `M11SymbolicOverloadCase_to_ISFSem` |
| G6-M11-5 | each missing M11 condition blocks the symbolic-overload profile | `missing_overload_symbol_blocks_profile`, `single_interpretation_blocks_profile`, `compatible_interpretations_blocks_profile`, `immaterial_overload_uptake_blocks_profile`, `independent_claim_blocks_overload_profile`, `present_disambiguation_blocks_profile`, `present_evaluator_resolution_blocks_profile`, `present_overload_boundary_blocks_profile` |
| G6-M11-6 | concrete M11 negative-control profiles witness every blocker | `symbolicOverloadNoSymbolProfile_blocked`, `symbolicOverloadSingleMeaningProfile_blocked`, `symbolicOverloadCompatibleProfile_blocked`, `symbolicOverloadImmaterialUptakeProfile_blocked`, `symbolicOverloadIndependentClaimProfile_blocked`, `symbolicOverloadDisambiguatedProfile_blocked`, `symbolicOverloadEvaluatorResolvedProfile_blocked`, `symbolicOverloadBoundaryPresentProfile_blocked` |
...
| G7-WD-11 | scoped operational contradiction model computes contradiction presence for active frame, active context, and contested claim | `operationalContradictionModel`, `operational_contradiction_active_contested_present`, `operationalContradictionProfile_to_present` |
| G7-WD-12 | resolved claim, inactive frame, and inactive context are not contradiction-present in the scoped operational contradiction model | `operational_contradiction_resolved_not_present`, `operational_contradiction_inactive_frame_not_present`, `operational_contradiction_inactive_context_not_present` |
| G7-WD-13 | contradiction presence is operationally discharged in the scoped core status but not source-backed or empirically validated | `warrantResolutionStatusWithOperationalCore`, `contradiction_is_operationally_discharged_in_scoped_model`, `operational_contradiction_not_source_backed`, `operational_contradiction_not_empirically_validated` |
| G7-WD-14 | satisfied evaluator criteria warrants acceptance in the scoped operational evaluator model | `operationalEvaluatorCriteria`, `operationalEvaluatorCriteria_satisfied`, `operationalEvaluatorCriteria_accepts` |
| G7-WD-15 | evaluator criteria acceptance is operationally discharged in the scoped core status but not source-backed or empirically validated | `evaluator_criteria_is_operationally_discharged_in_scoped_model`, `operational_evaluator_criteria_not_source_backed`, `operational_evaluator_criteria_not_empirically_validated` |
| G7-WD-16 | scoped operational power model computes relevance, validity dependence, and omission for a material power condition | `operationalPowerModel`, `operational_power_relevant`, `operational_power_validity_dependence`, `operational_power_omitted` |
| G7-WD-17 | scoped operational power model rejects unaffected group, immaterial condition, and ordinary-output controls | `operational_power_unaffected_group_not_relevant`, `operational_power_immaterial_condition_not_dependence`, `operational_power_ordinary_output_not_omitted` |
| G7-WD-18 | satisfied operational power profile yields all three power-condition predicates | `operationalPowerConditionProfile`, `operationalPowerConditionProfile_satisfied`, `operationalPowerConditionProfile_to_powerRelevant`, `operationalPowerConditionProfile_to_powerValidityDependence`, `operationalPowerConditionProfile_to_powerOmitted` |
| G7-WD-19 | power relevance, validity dependence, and omission are operationally discharged in the scoped core status | `power_relevant_is_operationally_discharged_in_scoped_model`, `power_validity_dependence_is_operationally_discharged_in_scoped_model`, `power_omitted_is_operationally_discharged_in_scoped_model` |
| G7-WD-20 | scoped operational suppression model computes support degradation for supported evidence, matched context, and suppressed claim | `operationalSuppressionModel`, `operational_suppression_support_degraded`, `operationalSuppressionProfile_to_supportDegraded` |
| G7-WD-21 | scoped operational suppression model rejects unsupported evidence, mismatched context, and ordinary-claim controls | `operational_suppression_unsupported_not_degraded`, `operational_suppression_mismatched_context_not_degraded`, `operational_suppression_ordinary_claim_not_degraded` |
| G7-WD-22 | suppression support-degradation is operationally discharged in the scoped core status but not source-backed or empirically validated | `suppression_support_degraded_is_operationally_discharged_in_scoped_model`, `operational_suppression_not_source_backed`, `operational_suppression_not_empirically_validated` |
| G7-WD-23 | scoped operational repair model computes repair obligation for repair-need bridge, responsible institution, and affected group | `operationalRepairModel`, `operational_repair_obligation`, `operationalRepairDiagnosis_to_repairObligation` |
| G7-WD-24 | scoped operational repair model rejects ordinary bridge, other institution, and other-group controls | `operational_repair_ordinary_bridge_not_obligation`, `operational_repair_other_institution_not_obligation`, `operational_repair_other_group_not_obligation` |
| G7-WD-25 | repair obligation is operationally discharged in the scoped core status but not source-backed or empirically validated | `repair_obligation_is_operationally_discharged_in_scoped_model`, `operational_repair_not_source_backed`, `operational_repair_not_empirically_validated` |
| G7-WD-26 | protocol-level operational empirical model computes full validation from validation, construct validity, reliability, and replication predicates | `operationalEmpiricalModel`, `operational_empirical_full_validation`, `operationalEmpiricalProtocol_to_full_validation` |
| G7-WD-27 | protocol-level operational empirical model rejects nominal validation, unvalidated objects, and other-claim controls | `operational_empirical_nominal_not_full`, `operational_empirical_unvalidated_not_full`, `operational_empirical_other_claim_not_full` |
| G7-WD-28 | empirical full validation is operationally discharged in the scoped core status but not source-backed or empirically validated | `empirical_full_validation_is_operationally_discharged_in_scoped_model`, `operational_empirical_not_source_backed`, `operational_empirical_not_empirically_validated` |
